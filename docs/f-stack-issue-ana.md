...
- **#842** 🟢open Extremely Bad Latency on TCP Connection for receiving Data
  - Conclusion: Official conclusion (open, not closed): officially confirmed receipt of a detailed report and further testing/investigation is planned; the issue remains open for now.
  - Fix/Workaround: The issue remains open; the maintainers have committed to further testing and investigation, with no final conclusion yet.
