...
| 对齐基线 | [06-方案设计](06-solution-design.md) **v1.9.4** / [07-里程碑](07-milestones.md) **v1.10**（本行自 v1.5 起未随版本同步刷新，v1.7 借 M4 回写顺手更正为当前版本；各版的历史对齐关系以两篇的「修订记录」行为准） |
