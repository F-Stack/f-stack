...
| **H. 2026-09-22 结项状态（新登记）** | **初步可用（G-F PASS 附条件）**；未执行项：F2/F3 故障与边界场景、跨进程 MP 集成、IPv6 百轮、rt12 管理面强判据、G-D 英文译审 | 已登记待办 | `work/recheck-20260921/gf-final-gate-20260922.md` |
