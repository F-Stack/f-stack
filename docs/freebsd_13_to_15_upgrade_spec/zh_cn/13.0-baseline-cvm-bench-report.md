...
**恢复**：rm_tmp_file.sh 是 mv→trash 设计（非真删），从 `/tmp/.trash/20260603-065813-1727226/data/workspace/f-stack-13.0-baseline/lib/ff_api.symlist` 用 `cp -p` 复原（sha256 `b70dfbca…3f5c523`，与主树和 runtime-fix-done 树完全一致），随后重编成功。
